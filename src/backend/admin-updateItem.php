<?php
    ...
    // 新增各欄位行程資訊至資料庫
    $sql = "UPDATE CAMPION.ITINERARY SET NAME = ? WHERE ID = ?";
    // $sql = "UPDATE CAMPION.ITINERARY SET NAME = ?, CONTEXT = ?, CATEGORY = ?, THEME = ?, COUNTRY = ?, CITY = ?, AGE = ?, PRICE = ?, BATCH = ?, START_STATE = ?, END_DATE = ? WHERE ID = ?";
